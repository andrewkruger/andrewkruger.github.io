...
A skew matrix will not rotate the data, but will shear the axis the same angle in opposite directions.  



It is the same as a scaling matrix where the scaling 
